...
do
	...
	do
		...
		cellModelfileName=HodgkinHuxley1952
		cellModelConstructor=CellHodgkinHuxley1952FromCellML
		...
		public:
			...
			// Strang Operator splitting with SDIRK
            		HeartConfig::Instance()->SetUseReactionDiffusionOperatorSplitting();
                        ...
                        HeartConfig::Instance()->SetUseReactionDiffusionThirdOrderRAOperatorSplittingMonodomainSolver();
