...
#September 2016
#Script to generate reference solutions using Chaste 3.4 for TenTusscher2006Epi cell model
		...
		*/
		...
		public:
            ...
            // Third-Order Operator splitting
                    ...
                    HeartConfig::Instance()->SetUseReactionDiffusionThirdOrderRAOperatorSplittingBidomainSolver();
